...
public class OPTAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static int TYPE_OPT = 0;
    private static int TYPE_BUTTON = 1;
    private Questions questions;
    private FinishOPTCallback callback;

    public OPTAdapter(Questions questions, FinishOPTCallback finishOPTCallback) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        if (viewType == TYPE_OPT)
            return new OPTViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.opt_item, viewGroup, false));
        else
